...
const NavBar: React.FC<NavBarProps> = () => {
  ...
  return (
    <Styled.Header navbarOpen={navbarOpen}>
      <Styled.Navbar>
        <Styled.LogoDiv>
          <a href="#">
            <Styled.LogoSVG
              ...
              viewBox="0 0 130 40"
            >
              <Styled.SvgPath d="M12.6 28.6a12.6 12.6 0 1 0 0-25.2 12.6 12.6 0 0 0 0 25.2Z" />
              <path
        ...
        <Styled.NavDesktop>
          <ul>
            <li>
              <Styled.LinkListAnchor className="desktopAncor" href="#">
                Get Free quotes »
              </Styled.LinkListAnchor>
            </li>
            <li>
              <Styled.LinkListAnchor href="#">
                How does it work
              </Styled.LinkListAnchor>
            </li>
            <li>
              <Styled.LinkListAnchor href="#">Log In</Styled.LinkListAnchor>
            </li>
            <li>
              <Styled.LinkListAnchor className=" signup-style" href="#">
        ...
        {/* MOBILE VIEW*/}
        <Styled.MenuButton onClick={toggleNav} navbarOpen={navbarOpen}>
          <Styled.SpanToggle navbarOpen={false}>
            Menu
            {navbarOpen ? <Styled.BarX /> : <Styled.BarIcon />}
          </Styled.SpanToggle>
        </Styled.MenuButton>
        <Styled.NavMobile>
          {navbarOpen && (
